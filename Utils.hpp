...
returnValue QPOASES_EXPORT print(	const real_t* const v,	/**< Vector to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT print(	const real_t* const M,	/**< Matrix to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT print(	const int_t* const index,	/**< Index array to be printed. */
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT myPrintf(	const char* s	/**< String to be written. */
						);


/** Prints qpOASES copyright notice.
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT printCopyrightNotice( );
...
returnValue QPOASES_EXPORT readFromFile(	real_t* data,				/**< Matrix to be read from file. */
							int_t nrow,					/**< Row number of matrix. */
							int_t ncol,					/**< Column number of matrix. */
 ...
 * \return SUCCESSFUL_RETURN \n
 		   RET_UNABLE_TO_OPEN_FILE \n
		   RET_UNABLE_TO_READ_FILE */
returnValue QPOASES_EXPORT readFromFile(	real_t* data,				/**< Vector to be read from file. */
							int_t n,					/**< Length of vector. */
							const char* datafilename	/**< Data file name. */
							);
 ...
 * \return SUCCESSFUL_RETURN \n
 		   RET_UNABLE_TO_OPEN_FILE \n
		   RET_UNABLE_TO_READ_FILE */
returnValue QPOASES_EXPORT readFromFile(	int_t* data,				/**< Vector to be read from file. */
							int_t n,					/**< Length of vector. */
							const char* datafilename	/**< Data file name. */
							);
 ...
 * \return SUCCESSFUL_RETURN \n
 		   RET_UNABLE_TO_OPEN_FILE  */
returnValue QPOASES_EXPORT writeIntoFile(	const real_t* const data,		/**< Matrix to be written into file. */
							int_t nrow,						/**< Row number of matrix. */
							int_t ncol,						/**< Column number of matrix. */
							const char* datafilename,		/**< Data file name. */
 ...
 * \return SUCCESSFUL_RETURN \n
 		   RET_UNABLE_TO_OPEN_FILE  */
returnValue QPOASES_EXPORT writeIntoFile(	const real_t* const data,		/**< Vector to be written into file. */
							int_t n,						/**< Length of vector. */
							const char* datafilename,		/**< Data file name. */
							BooleanType append = BT_FALSE	/**< Indicates if data shall be appended if the file already exists (otherwise it is overwritten). */
							);
 ...
 * \return SUCCESSFUL_RETURN \n
 		   RET_UNABLE_TO_OPEN_FILE */
returnValue QPOASES_EXPORT writeIntoFile(	const int_t* const integer,		/**< Integer vector to be written into file. */
							int_t n,						/**< Length of vector. */
							const char* datafilename,		/**< Data file name. */
...
returnValue QPOASES_EXPORT writeIntoMatFile(	FILE* const matFile,		/**< Pointer to Matlab binary file. */
...
real_t QPOASES_EXPORT getCPUtime( );


/** Returns the N-norm of a vector.
 * \return >= 0.0: successful */
real_t QPOASES_EXPORT getNorm(	const real_t* const v,	/**< Vector. */
...
inline BooleanType QPOASES_EXPORT isEqual(	real_t x,			/**< First real number. */
...
inline BooleanType QPOASES_EXPORT isZero(	real_t x,			/**< Real number. */
							real_t TOL = ZERO	/**< Tolerance for comparison. */
							);
...
inline real_t QPOASES_EXPORT getSign(	real_t arg	/**< real-valued argument whose sign is to be determined. */
						);


/** Returns maximum of two integers.
 * \return	Maximum of two integers */
inline int_t QPOASES_EXPORT getMax(	int_t x,	/**< First integer. */
						int_t y		/**< Second integer. */
						);
					
/** Returns minimum of two integers.
 * \return	Minimum of two integers */
inline int_t QPOASES_EXPORT getMin(	int_t x,	/**< First integer. */
						int_t y		/**< Second integer. */
						);
...
inline real_t QPOASES_EXPORT getMax(	real_t x,	/**< First real number. */
						real_t y	/**< Second real number. */
						);

/** Returns minimum of two reals.
 * \return	Minimum of two reals */
inline real_t QPOASES_EXPORT getMin(	real_t x,	/**< First real number. */
						real_t y	/**< Second real number. */
						);

/** Returns the absolute value of a real number.
 * \return	Absolute value of a real number */
inline real_t QPOASES_EXPORT getAbs(	real_t x	/**< Real number. */
						);

/** Returns the square-root of a real number.
 * \return	Square-root of a real number */
inline real_t QPOASES_EXPORT getSqrt(	real_t x	/**< Non-negative real number. */
						);


/** Computes the maximum violation of the KKT optimality conditions
 *	of given iterate for given QP data. */
returnValue QPOASES_EXPORT getKktViolation(	int_t nV,									/**< Number of variables. */
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT convertBooleanTypeToString(	BooleanType value, 		/**< Value to be written. */
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT convertSubjectToStatusToString(	SubjectToStatus value,	/**< Value to be written. */
											char* const string		/**< Input: String of sufficient size, \n
																		 Output: String containing value. */
											);
 ...
 * \return SUCCESSFUL_RETURN */
returnValue QPOASES_EXPORT convertPrintLevelToString(	PrintLevel value, 		/**< Value to be written. */
										char* const string		/**< Input: String of sufficient size, \n
																	 Output: String containing value. */
										);
 ...
 */
int_t QPOASES_EXPORT getSimpleStatus(	returnValue returnvalue, 				/**< ReturnValue to be analysed. */
 ...
 * \return SUCCESSFUL_RETURN \n
 *		   RET_INVALID_ARGUMENTS */
returnValue QPOASES_EXPORT normaliseConstraints(	int_t nV,		/**< Number of variables. */
									int_t nC, 		/**< Number of constraints. */
